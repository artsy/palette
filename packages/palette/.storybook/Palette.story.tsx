    ...
    return (
      <Box>
        ...
        <Text>
          ...
          constraint-based style props based on scales defined in your theme."
          There's a lot here, but in short what it means is: Take some values
          defined in a theme, define some function mixins to consume values in
          the theme, and map the output to React component props.
        </Text>
    ...
    <ThemeProvider theme={theme}>
      <Box p={2}>This is a box with 20px padding</Box>
        ...
        <Text>
          ...
          TypeScript, we get really nice intellisense as well as type-checking of
          the values passed into the prop.
        </Text>
...
\``}
        ...
        <Text>
          ...
          also <code>background</code> and <code>position</code> and others, each
          providing their own set of props that we can then tap into directly on
          the <code>Box</code> component.
        </Text>
...
\``}
        ...
        <Text>Now with this defined, we can then create something more complex:</Text>
