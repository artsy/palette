...
export const BarChartWithLabels = () => {
  return (
    <Box width="50%">
      <BarChart
        bars={[
...
BarChartWithLabels.story = {
  name: "BarChart with labels",
  parameters: { chromatic: { delay: 2000, diffThreshold: 1 } },
}

export const HeightLabelConstrainedToLeft = () => {
  return (
    <Box width="50%">
      <BarChart
        bars={[
...
HeightLabelConstrainedToLeft.story = {
  name: "Height label constrained to left",
  parameters: { chromatic: { delay: 2000, diffThreshold: 1 } },
}

export const HeightLabelConstrainedToRight = () => {
  return (
    <Box width="50%">
      <BarChart
        bars={[
...
HeightLabelConstrainedToRight.story = {
  name: "Height label constrained to right",
  parameters: { chromatic: { delay: 2000, diffThreshold: 1 } },
}

export const WithXAxisLabels = () => {
  return (
    <Box width="50%">
      <BarChart
        bars={[
...
WithXAxisLabels.story = {
  name: "With x-axis labels",
  parameters: { chromatic: { delay: 2000, diffThreshold: 1 } },
}

export const ZeroStateWithHighlightAndXAxisLabel = () => {
  return (
    <Box width="50%">
      <BarChart
        bars={[
...
ZeroStateWithHighlightAndXAxisLabel.story = {
  name: "Zero state with highlight and x axis label",
  parameters: { chromatic: { delay: 2000, diffThreshold: 1 } },
}

export const ZeroStateNoLabels = () => {
  return (
    <Box width="50%">
      <BarChart
        bars={[
...
ZeroStateNoLabels.story = {
  name: "Zero state no labels",
  parameters: { chromatic: { delay: 2000, diffThreshold: 1 } },
}
