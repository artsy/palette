...
LineChartWithLabels.story = {
  name: "LineChart with labels",
  parameters: { chromatic: { delay: 1000 } },
}

export const LineChartWithCustomHeight = () => {
  return (
    <Box width="50%">
      <LineChart
        height={250}
...
LineChartWithCustomHeight.story = {
  name: "LineChart with custom height",
