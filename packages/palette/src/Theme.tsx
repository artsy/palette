...
import { Theme as TTheme, THEME_V3, ThemeV3 } from "./themes"

export { THEME_V3 } from "./themes"
...
export const Theme: React.FC<ThemeProps> = ({
  children,
  theme: themeOrThemeKey = THEME_V3,
}) => {
  const theme =
    themeOrThemeKey === "v3" ? THEMES[themeOrThemeKey] : themeOrThemeKey
