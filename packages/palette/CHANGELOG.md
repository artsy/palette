...
- fix(dropdown): close on click does not re-arm hover until mouseout ([@dzucconi](https://github.com/dzucconi))
- Remove Text stories for props that don't exist (italic, underline, caps) ([@claude](https://github.com/claude))
...
- fix(filterselect): keeps selectedItems referentially stable ([@dzucconi](https://github.com/dzucconi))
...
- chore(deps): re-organizes dependencies ([@dzucconi](https://github.com/dzucconi))
- chore: modernizes babel output ([@dzucconi](https://github.com/dzucconi))
- chore(deps): moves icons into peer deps ([@dzucconi](https://github.com/dzucconi))
...
- fix(autocompleteinput): ensures we fill gap between search input and dropdown ([@dzucconi](https://github.com/dzucconi))
...
- feat(basetabs): supports native html div props ([@dzucconi](https://github.com/dzucconi))
...
- fix(image): ensures image does not collapse ([@dzucconi](https://github.com/dzucconi))
...
- fix(autocomplete): fixes initial render in safari ([@dzucconi](https://github.com/dzucconi))
...
- fix(image): refactors to match original behavior ([@dzucconi](https://github.com/dzucconi))
- feat(image): implements a native image component ([@dzucconi](https://github.com/dzucconi))
...
- Removes delay when not transitioning ([@dzucconi](https://github.com/dzucconi))
...
- fix(bordered-radio): more border specificity fixes ([@damassi](https://github.com/damassi))
...
- fix(modaldialog): corrects type for title ([@dzucconi](https://github.com/dzucconi))
...
- fix: replaces lodash with es-toolkit ([@dzucconi](https://github.com/dzucconi))
...
- fix: drops minor focus-visible polyfill handling ([@dzucconi](https://github.com/dzucconi))
...
- fix(radiogroup): supports default value of false ([@dzucconi](https://github.com/dzucconi))
...
- fix(message): fixes message background to match figma spec ([@dzucconi](https://github.com/dzucconi))
...
- fix(modaldialog): passes in zindex correctly ([@dzucconi](https://github.com/dzucconi))
...
- chore: allow null | undefined for image prop in Card ([@mzikherman](https://github.com/mzikherman))
...
- feat(pagination): adds pagination skeleton ([@dzucconi](https://github.com/dzucconi))
...
- fix(tooltip): prevent parent from altering font-styles ([@dzucconi](https://github.com/dzucconi))
...
- feat(theme): roughs in a dark theme ([@dzucconi](https://github.com/dzucconi))
...
- fix(button): avoids passing the loading prop to the underlying dom node ([@dzucconi](https://github.com/dzucconi))
...
- fix(checkbox): moves focus state onto focus-visible ([@dzucconi](https://github.com/dzucconi))
...
- Revert "fix(useposition): handles scrolling within divs (#1343)" ([@dzucconi](https://github.com/dzucconi))
...
- fix(modaldialog): corrects padding with header ([@dzucconi](https://github.com/dzucconi))
