...
When building layouts and components, palette hooks into a handful of reusable spacing units
[Theme file](https://github.com/artsy/palette/blob/master/packages/palette/src/Theme.tsx#L116). This allows us to constrain the possibilities available to
