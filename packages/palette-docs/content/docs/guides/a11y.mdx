...
In general components in Palette are built with accessibility best-practices in mind, however they may  still have some issues. When encountering problems of any kind please file bugs with the Design System Working Group or (if external to Artsy) [leave an issue on Github](https://github.com/artsy/palette/issues/new).
